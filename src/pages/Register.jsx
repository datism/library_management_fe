  ...
  const handleSignUp = async () => {
    if (CheckValidate()) {
      ...
      try {
        ...
        openNotification(
          'Đăng kí thất bại: ' + e.response.data.errorMessage,
          'error',
        );
      }
    }
      ...
      <div className="login-box register-box">
        ...
        <div className="info">
          ...
          <div className="acc-info">
            ...
            <p id="warning5" className="warning hidden">
              Cần nhập Họ tên và Số điện thoại!!!
            </p>
            <input
              id="register-email"
              type={'email'}
            ...
            <div id="register-gender">
              {genderList.map((e, index) => (
                <div key={index} className="box-radio">
                  <input
                    className={
                      index ? 'input-radio' : 'input-radio first-radio'
                    }
                    type="radio"
            ...
            <p id="warning7" className="warning hidden">
              Cần chọn giới tính!!!
            </p>
          </div>
        </div>
        <button className="button-form button-blue" onClick={handleSignUp}>
          Đăng ký
        </button>
        <p
          id="warning8"
        ...
        >
          {response.status === 200
            ...
            : 'Another account has already existed.'}
        </p>
      </div>
    </div>
  );
